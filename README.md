...
Issue หนึ่งรายการมีประเภทเดียวใน 3 ประเภท — **Bug**, **Utest**, **CR** — และถือฟิลด์:
...
start / end วันเริ่ม-วันสิ้นสุด (milestone ตั้ง end = start ให้อัตโนมัติ)
progress    0-100
```

Project เองก็มีวันเริ่ม/วันสิ้นสุดของตัวเอง ใช้บอกกรอบเวลาที่ตกลงไว้
แยกจากวันของงานแต่ละตัวในแผน
